...
const CtaSection: React.FC = () => (
  <section className="py-24 px-6 text-center relative z-10 bg-white">
    ...
    <p className="text-lg text-[#0c468b] max-w-3xl mx-auto mb-12 leading-relaxed">
    ...
    <button className="px-8 py-3 border-2 border-[#0c468b] text-[#0c468b] hover:bg-[#0c468b] hover:text-white transition-colors font-bold text-sm rounded-lg uppercase tracking-wider">
      Contact Us
    </button>
  </section>
);
